...
search/rest, up to 1,000 turns. An editable box beneath the hero shows clickable completions. Backspace edits; Escape cancels. More actions → Type a command opens it on touch devices.
