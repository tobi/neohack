...
/* neonethack modifications, 2026-09-03 through 2026-09-05: headless port
 * declaration. See CHANGES.neonethack.md; original NGPL notices retained. */
#ifndef WINPROCS_H
#define WINPROCS_H
...
enum wp_ids { wp_tty = 1, wp_X11, wp_Qt, wp_mswin, wp_curses,
              wp_chainin, wp_chainout, wp_shim, wp_headless,
