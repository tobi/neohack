...
/* neonethack modifications, 2026-09-03 through 2026-09-05: headless event
 * declarations. See CHANGES.neonethack.md; original NGPL notices retained. */
#ifndef EXTERN_H
#define EXTERN_H
...
extern void headless_creature_died(struct monst *);
...
extern boolean headless_pickup_review(void);
extern void headless_pickup_menu(winid);
extern void headless_pickup_suggestion(winid, boolean);
extern void headless_item_looted(struct obj *, long, const char *, struct obj *);
extern void headless_container_opened(struct obj *);
extern boolean headless_pickup_matches(struct obj *, boolean);
