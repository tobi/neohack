...
import { readTar, hostPathLeak } from '../scripts/archive.mjs';
import { sourcePath } from '../scripts/source-files.mjs';
...
test('archive policies retain required SDK source and virtual paths, not generated files or host paths', () => {
  ...
  for (const p of ['lib/neonethack/dist/a.js', 'lib/neonethack/build/file', 'sessions/meta.json', 'lib/neonethack/third_party/emscripten-runtime/system/lib/libc/musl/dist/compiled.o', 'lib/neonethack/engine/src/compiled.o', 'lib/neonethack/third_party/emscripten-runtime/system/lib/libc/compiled.a']) assert.throws(() => sourcePath(p));
