...
test('C stdio discovery syntax handles all six genuine question kinds and partial stacks',{timeout:30000},async t=>{
  ...
  await client.connect(new StdioClientTransport({command:root+'/build/native/neonethack-mcp',args:[root+'/engine/playground/nethack',root+'/engine/playground',sessions],stderr:'pipe'}));
