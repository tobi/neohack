...
| `interrupted` | An activity stopped at a real input boundary. Completed work and spent turns remain. | Inspect remaining perceived items and events. Continuing a meal or study requires a deliberate new named action; observe/retry/resume never continues it automatically. |
