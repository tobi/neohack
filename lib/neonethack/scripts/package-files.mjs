...
export const distModules = [
  'typescript/client', 'typescript/types', 'typescript/requests',
  'typescript/native', 'typescript/wasm', 'typescript/webmcp',
  'mcp/cli', 'mcp/server', 'mcp/tools',
];
...
export const nativeFiles = [
  ...
  ...['README.md', 'NOTICE.md', 'license', 'LUA-LICENSE.txt', 'SOURCE.json',
    ...
    'protocol/catalog.json', 'protocol/request.schema.json', 'protocol/response.schema.json',
