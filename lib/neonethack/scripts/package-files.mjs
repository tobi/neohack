...
export const distModules = [
  'typescript/equipment', 'typescript/low', 'typescript/high', 'typescript/index', 'typescript/client', 'typescript/types', 'typescript/requests',
  'typescript/hero', 'typescript/script', 'typescript/vocabulary', 'typescript/hero-events', 'typescript/lifecycle',
  'typescript/native', 'typescript/wasm', 'typescript/webmcp',
  'typescript/reference-client', 'typescript/public-trace', 'typescript/self-state', 'typescript/navigator',
  'mcp/cli', 'mcp/runtime', 'mcp/rpc', 'mcp/service', 'mcp/agent', 'mcp/agent-data', 'mcp/compact', 'mcp/tools', 'mcp/protocol-data', 'mcp/tool-data',
];
...
export const nativeFiles = [
  'bin/neonethack', 'include/neonethack.h', 'lib/libneonethack.a',
