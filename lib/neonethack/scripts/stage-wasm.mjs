...
await writeFile(`${out}/build.json`, JSON.stringify({ version: 1, sourceHash: (await sourceState()).hash, emscripten: JSON.parse(await readFile(`${emscripten}/emscripten-version.txt`, 'utf8')), lua: '5.4.9', compiled: hashes }, null, 2) + '\n');
